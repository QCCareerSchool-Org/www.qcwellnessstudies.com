...
import LiveChatIcon from '@/images/icon-live-chat.svg';
...
const Page: NextPageWithLayout<Props> = ({ price }) => (
  <>
      ...
      <div className="container text-center">
        <div className="row mt-5">
          <div className="col-12 col-md-10 offset-md-1">
            <p><Image src={FCGPCertificationImage} alt="Formal Caregiving Professional Certification" /></p>
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-10 offset-md-1 col-lg-10 offset-lg-1 mb-3">
            ...
            <p><em>Are you looking for training to care for your loved ones at home? QC&apos;s Personal Caregiver course could be for you! <Link href="/courses-and-tuition/personal-caregiving" className="text-info">Learn more about Personal Caregiving</Link>.</em></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-12 col-md-6 col-lg-5 offset-lg-1 mb-5">
            <p><Image className="img-fluid" src={OutlineAImage} alt="Caregiver Course Unit A" /></p>
          ...
          <div className="col-12 col-md-6 col-lg-5 mb-5">
            <p><Image className="img-fluid" src={OutlineBImage} alt="Caregiver Course Unit B" /></p>
          ...
          <div className="col-12 col-md-6 col-lg-5 offset-lg-1 mb-5">
            <p><Image className="img-fluid" src={OutlineCImage} alt="Caregiver Course Unit C" /></p>
          ...
          <div className="col-12 col-md-6 col-lg-5 mb-5">
            <p><Image className="img-fluid" src={OutlineDImage} alt="Caregiver Unit D" /></p>
          ...
          <div className="col-12 col-md-6 col-lg-5 offset-lg-1 mb-5">
            <p><Image className="img-fluid" src={OutlineEImage} alt="Caregiver Unit E" /></p>
          ...
          <div className="col-12 col-md-6 col-lg-5 mb-5">
            <p><Image className="img-fluid" src={OutlineFImage} alt="Caregiver Unit F" /></p>
          ...
          <div className="text-center col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
            ...
            <Link href="/courses-and-tuition/professional-caregiving#outline" className="btn btn-outline-secondary text-uppercase">Full Course Outline</Link>
          </div>
        </div>
      </div>
    </section>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-sm-8 offset-sm-2 col-lg-5 offset-lg-0 col-xl-4">
              <PriceCard price={price} courses={[ 'fc' ]} />
            </div>
      ...
      <div className="container">
        <div className="row">
          <div className="text-center col-12 col-md-10 offset-md-1 col-lg-10 offset-lg-1 mb-4">
            <p><Image src={LiveChatIcon as StaticImageData} alt="live chat icon" /></p>
          ...
          <div className="col-12 col-lg-5 offset-lg-1">
            <p><Image className="img-fluid" src={TutorImage} alt="tutor" /></p>
          ...
          <div className="mt-4 mt-lg-0 col-12 col-lg-5">
            <p><Image className="img-fluid" src={AdvisorImage} alt="student advisor" /></p>
    ...
    <EnrollmentSection courseCodes={[ 'fc' ]}>
      Start your online caregiver training today<br />and launch an exciting, rewarding career!
    </EnrollmentSection>
  </>
);
