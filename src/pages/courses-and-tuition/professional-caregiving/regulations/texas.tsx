			...
			<section className="bg-light text-dark">
				<div className="container">
					<div className="col-12 col-lg-10 offset-lg-1 mb-6 mb-md-0">
						...
						<ul>
							<li>The STAR+PLUS Medicaid Waiver is for individuals unable to manage their activities of daily living without support.</li>
							<li>The Community First Choice (CFC) Program is for individuals of any age who need help with daily tasks or activities of daily living. Your client will be re-assessed annually to determine whether they still qualify for the CFC Program.</li>
							<li>The Primary Home Care (PHC) Program is for disabled individuals over the age of 21 who require assistance to perform at least one activity of daily living. Their disability must be due to a medical condition, and must be documented by a medical professional.</li>
						</ul>
