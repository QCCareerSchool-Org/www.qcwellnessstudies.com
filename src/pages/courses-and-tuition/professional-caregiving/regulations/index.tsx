        ...
        <div className="container text-center">
          <div className="row">
            <div className="col-12 col-lg-8 offset-lg-2">
              ...
              <p><Link href="/courses-and-tuition/professional-caregiving/regulations/california"><a className="text-info">California</a></Link></p>
              <p><Link href="/courses-and-tuition/professional-caregiving/regulations/florida"><a className="text-info">Florida</a></Link></p>
              <p><Link href="/courses-and-tuition/professional-caregiving/regulations/illinois"><a className="text-info">Illinois</a></Link></p>
              <p><Link href="/courses-and-tuition/professional-caregiving/regulations/new-york"><a className="text-info">New York</a></Link></p>
              <p><Link href="/courses-and-tuition/professional-caregiving/regulations/pennsylvania"><a className="text-info">Pennsylvania</a></Link></p>
              <p><Link href="/courses-and-tuition/professional-caregiving/regulations/texas"><a className="text-info">Texas</a></Link></p>
            </div>
          </div>
        </div>
      </section>
