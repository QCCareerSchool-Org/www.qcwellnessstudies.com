...
import OutlineFImage from './outline-f.jpg';
import WhatYoullLearnImage from './pc-what-youll-learn.jpg';
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
            <p><Image className="img-fluid" src={PromoImage} alt="December Promo" /></p>
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-6 col-lg-5">
            ...
            <p>If you are looking to become a temporary caregiver for your loved one and not a professional caregiver, QC also offers an <Link href="/courses-and-tuition/personal-caregiving" className="text-info">informal caregiver course</Link>.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-10 offset-md-1 col-lg-7 offset-lg-0">
            ...
            <p>It&apos;s always a good idea to check local regulations before starting a new profession. Currently, the United States has no standardized <a href="https://www.bls.gov/OOH/healthcare/home-health-aides-and-personal-care-aides.htm#tab-4" target="blank" rel="noopener">licensing requirements</a> or training regulations for caregivers who work independently. &ldquo;Independent&rdquo; means that they are employed directly by their clients and bill clients directly.</p>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-12 col-md-6 col-lg-4">
            <p className="d-none d-lg-block"><Image src={WhatYoullLearnImage} className="text-center img-fluid" alt="What you&apos;ll learn in the caregiver course" /></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        ...
        <div className="container">
          <div className="row my-5" id="unitA">
            <div className="col-12 col-md-10 offset-md-1 col-lg-4 text-lg-left mb-4">
              <Image src={OutlineAImage} className="rounded img-fluid mt-2" alt="Caregiver Course Unit A" />
            </div>
        ...
        <div className="container">
          <div className="row my-5" id="unitB">
            <div className="col-12 col-md-10 offset-md-1 col-lg-4 text-lg-left mb-4">
              <Image src={OutlineBImage} className="rounded img-fluid mt-2" alt="Caregiver Course Unit B" />
            </div>
            <div className="col-12 col-md-10 offset-md-1 col-lg-6 offset-lg-0 text-lg-left mb-4">
        ...
        <div className="container">
          <div className="row my-5" id="unitC">
            <div className="col-12 col-md-10 offset-md-1 col-lg-4 text-lg-left mb-4">
              <Image src={OutlineCImage} className="rounded img-fluid mt-2" alt="Caregiver Course Unit C" />
            </div>
            <div className="col-12 col-md-10 offset-md-1 col-lg-6 offset-lg-0 text-lg-left mb-4">
        ...
        <div className="container">
          <div className="row my-5" id="unitD">
            <div className="col-12 col-md-10 offset-md-1 col-lg-4 text-lg-left mb-4">
              <Image src={OutlineDImage} className="rounded img-fluid mt-2" alt="Caregiver Course Unit D" />
            </div>
            <div className="col-12 col-md-10 offset-md-1 col-lg-6 offset-lg-0 text-lg-left mb-4">
        ...
        <div className="container">
          <div className="row my-5" id="unitE">
            <div className="col-12 col-md-10 offset-md-1 col-lg-4 text-lg-left mb-4">
              <Image src={OutlineEImage} className="rounded img-fluid mt-2" alt="Caregiver Unit E" />
            </div>
            <div className="col-12 col-md-10 offset-md-1 col-lg-6 offset-lg-0 text-lg-left mb-4">
        ...
        <div className="container">
          <div className="row my-5" id="unitF">
            <div className="col-12 col-md-10 offset-md-1 col-lg-4 text-lg-left mb-4">
              <Image src={OutlineFImage} className="rounded img-fluid mt-2" alt="Caregiver Unit F" />
            </div>
            <div className="col-12 col-md-10 offset-md-1 col-lg-6 offset-lg-0 text-lg-left mb-4">
