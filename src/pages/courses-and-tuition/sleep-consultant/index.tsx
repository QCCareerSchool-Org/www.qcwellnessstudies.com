        ...
        <div className="row">
          <div className="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
            <div className="container text-dark text-center">
              ...
              <p className="lead mb-5">This Cyber Monday, save an extra $200 on your sleep consultant course tuition.<br />This discount will be automatically applied when you enroll.</p>
