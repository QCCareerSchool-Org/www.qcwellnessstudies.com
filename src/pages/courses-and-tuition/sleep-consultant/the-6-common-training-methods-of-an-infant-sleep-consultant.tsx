        ...
        <div className="container">
          <div className="row">
            <div>
              ...
              <p>Want to learn more about the type of training you’ll get from QC’s Sleep Consultant Course? Check out our feature on QC Wellness Studies graduate, <Link href="/student-resources/blog/student-features/sarah-pashniak"><a>Sarah Pashniak!</a></Link></p>
            </div>       
          </div>
        </div>
      </section>
