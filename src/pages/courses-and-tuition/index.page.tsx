...
const Page: NextPage = () => (
  <>
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-12 mb-5 col-md-12 col-lg-7 mb-lg-0 col-xl-8 text-center text-lg-left order-first order-lg-last">
            ...
            <Link href="/caregiver" className="btn btn-secondary">LEARN MORE</Link>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-12 mb-5 col-md-12 col-lg-7 mb-lg-0 col-xl-8 text-center text-lg-left order-first order-lg-last">
            ...
            <Link href="/courses-and-tuition/sleep-consultant" className="btn btn-secondary">LEARN MORE</Link>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-12 mb-5 col-md-12 col-lg-7 mb-lg-0 col-xl-8 text-center text-lg-left order-first order-lg-last">
            ...
            <Link href="/courses-and-tuition/skincare-consultant" className="btn btn-secondary">LEARN MORE</Link>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-12 mb-5 col-md-12 col-lg-7 mb-lg-0 col-xl-8 text-center text-lg-left order-first order-lg-last">
            ...
            <Link href="/courses-and-tuition/aging-in-place" className="btn btn-secondary">LEARN MORE</Link>
          </div>
        </div>
      </div>
    </section>
    ...
    <EnrollmentSection>
      With QC&apos;s flexible online training, enroll and start your course(s) at any time. There are no start dates or deadlines to worry about. Complete your training as quickly as you&apos;d like, or take your time. The choice is yours!
    </EnrollmentSection>
  </>
);
