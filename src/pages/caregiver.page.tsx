      ...
      <div className="container">
        ...
        <div className="row d-flex align-items-center">
          <div className="col-12 mb-4 col-sm-10 col-md-8 offset-sm-1 offset-md-2 offset-lg-0 col-lg-6 mb-lg-0 text-center">
            ...
            <Link href="/courses-and-tuition/professional-caregiving" className="btn btn-secondary mb-4">LEARN MORE</Link>
          </div>
          <div className="col-12 col-sm-10 col-md-8 offset-sm-1 offset-md-2 offset-lg-0 col-lg-6 text-center">
            ...
            <Link href="/courses-and-tuition/personal-caregiving" className="btn btn-secondary mb-4">LEARN MORE</Link>
          </div>
        </div>
        <hr />
      </div>
