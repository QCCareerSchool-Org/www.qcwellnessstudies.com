...
const Page: NextPage = () => (
  <DefaultLayout>
    ...
    <section id="certifications" className="text-center">
      <div className="container">
        <p><img className="img-fluid" width="90" height="90" src={require('../images/certification-seal.png')} /></p>
        ...
        <div className="row">
          ...
          <div className="col-12 mb-5 col-md-6 mb-md-0 col-lg-5 offset-lg-1 mb-5">
            ...
            <p className="text-uppercase"><a className="text-info" href="/courses-and-tuition/personal-care-aide/"><strong>view course</strong></a></p>
          </div>
          ...
          <div className="col-12 col-md-6 col-lg-5 mb-5 ">
            ...
            <p className="text-uppercase"><a className="text-info" href="/courses-and-tuition/sleep-consultant/"><strong>view course</strong></a></p>
          </div>
          ...
          <div className="col-12 mb-5 col-md-6 mb-md-0 col-lg-5 offset-lg-1">
            ...
            <p className="text-uppercase"><a className="text-info" href="/courses-and-tuition/skincare-consultant/"><strong>view course</strong></a></p>
          </div>
          ...
          <div className="col-12 col-md-6 col-lg-5">
            ...
            <p className="text-uppercase"><a className="text-info" href="/courses-and-tuition/aging-in-place/"><strong>view course</strong></a></p>
          </div>
      ...
      <div className="container">
        ...
        <div className="row d-flex align-items-center mb-5 mb-md-4">
          ...
          <div className="col-4 offset-4 col-md-2 offset-md-0 offset-lg-1 offset-xl-2 text-center mb-2 mb-md-0">
            <img className="img-fluid" width="60" height="60" src={require('../images/icon-why-choose-qc-proven.svg')} />
          </div>
        ...
        <div className="row d-flex align-items-center mb-5 mb-md-4">
          ...
          <div className="col-4 offset-4 col-md-2 offset-md-0 offset-lg-1 offset-xl-2 text-center mb-2 mb-md-0">
            <p><img className="img-fluid" width="60" height="60" src={require('../images/icon-why-choose-qc-online.svg')} /></p>
          </div>
        ...
        <div className="row d-flex align-items-center mb-5 mb-md-4">
          ...
          <div className="col-4 offset-4 col-md-2 offset-md-0 offset-lg-1 offset-xl-2 text-center mb-2 mb-md-0">
            <p><img className="img-fluid" width="60" height="60" src={require('../images/icon-why-choose-qc-tutor-guide.svg')} /></p>
          </div>
        ...
        <div className="row d-flex align-items-center mb-5 mb-md-4">
          ...
          <div className="col-4 offset-4 col-md-2 offset-md-0 offset-lg-1 offset-xl-2 text-center mb-2 mb-md-0">
            <p><img className="img-fluid" width="60" height="60" src={require('../images/icon-why-choose-qc-training.svg')} /></p>
          </div>
        ...
        <div className="row d-flex align-items-center">
          ...
          <div className="col-4 offset-4 col-md-2 offset-md-0 offset-lg-1 offset-xl-2 text-center mb-2 mb-md-0">
            <p><img className="img-fluid" width="60" height="60" src={require('../images/icon-why-choose-qc-no-hidden-fees.svg')} /></p>
          </div>
