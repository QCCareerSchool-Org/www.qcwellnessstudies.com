        ...
        <div className="row d-flex align-items-center">
          <div className="col-12">
            <div className="text-light text-center">
              <h1 className="text-center">10 Tips for Creating the Ideal Sleep Environment</h1>
              <p><Link href="/tip-sheets/10-tips-creating-sleep-environment.pdf"><a className="btn btn-primary" rel="noopener noreferrer" target="_blank"><strong>Download PDF</strong></a></Link></p>
            </div>
          </div>
        </div>
      </div>
