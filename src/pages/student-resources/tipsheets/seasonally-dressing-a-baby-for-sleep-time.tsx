        ...
        <div className="row d-flex align-items-center">
          <div className="col-12">
            <div className="text-light text-center">
              ...
              <p><Link href="/tip-sheets/Seasonally-dressing-baby-for-sleep.pdf"><a className="btn btn-primary" rel="noopener noreferrer" target="_blank"><strong>Download PDF</strong></a></Link></p>
            </div>
          </div>
        </div>
      </div>
