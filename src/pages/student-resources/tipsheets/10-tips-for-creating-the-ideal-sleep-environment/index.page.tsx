...
const Page: NextPage = () => (
  <>
    <SEO
      ...
      image={{
        src: GirlReadingBookBedImage.src,
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2">
            ...
            <p><Image className="img-fluid" src={GirlReadingBookBedImage} alt="little girl reading in bed" /></p>
            ...
            <p><Image className="img-fluid" src={YellowCotBlanketImage} alt="baby room interior" /></p>
            ...
            <p><Image className="img-fluid" src={HappyFamilyMotherBabyImage} alt="happy mother playing with her baby in the bedroom" /></p>
            ...
            <p><Image className="img-fluid" src={MotherHomeHospitalNewbornImage} alt="newborn baby nursery" /></p>
            ...
            <p><Image className="img-fluid" src={BabyBoySleepingTeddyImage} alt="Boy sleeping on bed with teddy bear" /></p>
            ...
            <p><Image className="img-fluid" src={ReadingStoryImage} alt="Mom reading interesting story" /></p>
          </div>
        </div>
      </div>
    </section>
