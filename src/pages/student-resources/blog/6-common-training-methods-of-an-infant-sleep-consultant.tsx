...
const Page: NextPage = () => (
  <DefaultLayout>
    ...
    <SEO
      ...
      image={{
        src: require('../../../images/sr-loving-mom-carrying-her-newborn-baby-at-home.jpg'),
      ...
      <div className="container col-12 mb-4 col-sm-10 col-md-8 col-lg-6 mb-lg-0">
        <div className="row mb-4">
          <div className="col-12">
            ...
            <p>First of all, of course, the main benefit of infant sleep consulting is improving an infant’s sleep! This brings forward many other benefits – a well-rested baby usually means well-rested parents, and that allows the family’s general mental and physical health to improve.</p>
            ...
            <div>
              <p><img className="img-fluid" src={require('../../../images/sr-adorable-baby-sleeping-blue-bassinet-canopy.jpg')} alt="Adorable baby sleeping in blue bassinet" /></p>
            </div>
            <h4>6 Common Sleep Training Methods</h4>
            <h4>1. The “Cry It Out”Method</h4>
            <p>The “cry it out” method, also known as the extinction method, is actually one of the best-known methods of sleep training. People often mistakenly believe that this fully self-soothing method is the <em>only</em> type of sleep training. This strategy allows babies to learn how to self-soothe and fall asleep independently without involvement from the parent or caregiver. Many caregivers find this method off-putting or harsh and discount sleep training as a result. It’s important for families to understand that sleep consultants can work with a variety of sleep training methods to suit each infant and caregiver’s needs. The “cry it out” method may be too harsh for some families but be effective for others.</p>
            <h4>2. The Check and Console Method</h4>
            <p>Also known as “graduated extinction,” the check and console method requires caregivers to periodically check in on infants to offer support. You may have also heard this method described as the “Ferber method.” The check and console method is credited to Dr. Richard Ferber, one of the first physicians to write about sleep training.</p>
            ...
            <div>
              <p><img className="img-fluid" src={require('../../../images/sr-eight-month-old-baby-crying-sad.jpg')} alt="Eight month old baby crying" /></p>
            </div>
            <h4>3. The Chair Method</h4>
            ...
            <h4>4. The Fading Method</h4>
            <p>The fading method involves encouraging the infant to develop self-soothing techniques very gradually, with a lot of caregiver soothing. This method is based on the theory that the easiest and most effective way to change habits is by doing so gradually. This method doesn’t offer a quick fix – the fading method aims for gradual, gentle results than the much faster extinction methods.</p>
            ...
            <h4>5. The Pick Up Put Down Method</h4>
            ...
            <p>Note that this method doesn’t suggest that caregivers rock the baby to sleep – almost all sleep training methods recommend putting a baby down tired but still awake. If the infant resumes crying after being placed in the crib, the caregiver should provide verbal encouragement before picking the baby up again.</p>
            <div>
              <p><img className="img-fluid" src={require('../../../images/sr-sweet-crying-newborn-baby-mom.jpg')} alt="Sweet crying newborn baby" /></p>
            </div>
            <h4>6. “No Cry” Methods</h4>
            ...
            <div>
              <p><img className="img-fluid" src={require('../../../images/sr-loving-mom-carrying-her-newborn-baby-at-home.jpg')} alt="Loving mom carying of her newborn baby at home" /></p>
            </div>
    ...
    <style jsx>{`
      ...
      #heroSection{background-image:url(${require('../../../images/sr-hero-6-common-training-methods-of-an-infant-sleep-consultant.jpg')});background-size:cover;background-position:center}
