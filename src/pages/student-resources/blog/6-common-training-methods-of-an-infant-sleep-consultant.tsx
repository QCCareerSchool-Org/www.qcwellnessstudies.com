  ...
  <DefaultLayout>
    ...
    <section>
      <div className="container">
        <div className="row">
          <div className="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2">
            <p className="lead">Contrary to the common the phrase, “sleep like a baby,” teaching a baby how to sleep can be surprisingly challenging! To exhausted parents and babies everywhere, infant sleep consultants are superheroes. <Link href="/courses-and-tuition/sleep-consultant"><a>Infant sleep consultants</a></Link> help parents and infants learn good sleep habits through sleep training.</p>
