...
const Page: NextPage = () => (
  <DefaultLayout>
    ...
    <SEO
      ...
      description="Before you begin your exciting new career, you’ll have a lot to think about and plan for. One consideration that may be overlooked at first is insurance. While some types of insurance are optional, there are certain types of insurance that are strongly recommended to operate a sleep consulting business."
      canonical="/student-resources/blog/insurance"
      image={{
        src: require('../../../images/close-handshake.jpg'),
        alt: 'Close handshake',
      }}
    />
      ...
      <div className="container text-light">
        <div className="row">
          <div className="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2">
            <h1 className="text-center">The Different Types of Insurance Recommended for Sleep Consultants</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section>
      <div className="container">
        <div className="row">
          <div className="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2">
            <p className="lead">Sleep consulting can be an incredibly rewarding career. To many parents, your advice will be life-changing; to them, you’re a superhero!</p>
            <p>People become sleep consultants for different reasons. You may choose to train to be a <Link href="/courses-and-tuition/sleep-consultant"><a>sleep consultant</a></Link> so that you can help parents and parents-to-be better adjust to changes in their life. You may be a parent yourself, looking for ways to help your children sleep better at night. You may just have a calling for helping others. Regardless of why you’re interested in becoming a sleep consultant, there’s a major perk to the job: the potential to start your own business.</p>
            ...
            <p><img className="img-fluid" src={require('../../../images/close-handshake.jpg')} alt="Close handshake" /></p>                  
            <h4>Why Do You Need Insurance as a Sleep Consultant?</h4>
            ...
            <h4>What Could Happen Without Insurance?</h4>
            ...
            <h4>Types of Insurance Recommended for Sleep Consultants</h4>
            ...
            <h4>Public and Professional Liability Insurance</h4>
