  ...
  <DefaultLayout>
    ...
    <section>
      <div className="container">
        <div className="row">
          <div className="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2">
            <p className="lead">As a certified Sleep Consultant, you will not be required to know baby sign language. However, this can prove to be a useful tool to recommend to your clients!</p>
            <p className="lead">Not a certified Sleep Consultant yet? Enroll today in  <Link href="/courses-and-tuition/sleep-consultant"><a> QC Wellness Studies’ online Sleep Consultant Course!</a></Link></p>     
            <p><img className="img-fluid" src={require('../../../images/sl-baby-sign-language-what-is.jpg')} alt="happy baby with raised arms" /></p>
            <h4>What is Baby Sign Language?</h4>
            ...
            <h4>When to Teach Baby Sign Language</h4>
            ...
            <p><Link href="https://www.youtube.com/watch?v=MchIPOm2G0Q"><a rel="noopener noreferrer" target="_blank">Watch this informative video</a></Link> on the Top 15 signs your clients should teach their infants!</p>
            ...
            <h4>How This Affects You as the Sleep Consultant</h4>
