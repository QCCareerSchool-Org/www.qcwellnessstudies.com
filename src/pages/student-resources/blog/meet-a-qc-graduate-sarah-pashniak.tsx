...
const Page: NextPage = () => (
  <DefaultLayout>
    ...
    <SEO
      ...
      canonical="/student-resources/blog/meet-a-qc-graduate-sarah-pashniak"
      image={{
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2">
            ...
            <h4>Becoming a Sleep Consultant</h4>
            ...
            <h4>Starting a Sleep Consulting Business</h4>
            ...
            <h4>Taking a Sleep Consulting Course</h4>
