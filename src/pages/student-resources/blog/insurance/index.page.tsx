...
import CloseHandshakeImage from './close-handshake.jpg';
import HeroBackgroundImage from './hero-bg.jpg';
import YawningBabyGirlImage from './yawning-baby-girl.jpg';
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 mb-4 col-sm-10 offset-sm-1 col-md-8 offset-md-2">
            ...
            <p><Image className="img-fluid" src={YawningBabyGirlImage} alt="Yawning Baby Girl" /></p>
            ...
            <p><Image className="img-fluid" src={CloseHandshakeImage} alt="Closed handshake" /></p>
            ...
            <p>You may be offered specific insurance packages that seem to cover everything you need in a business. These packages could be sold as &ldquo;coaching insurance,&rdquo; &ldquo;consulting insurance,&rdquo; or similar. While these packages can work for you and your business, they may come at a higher cost than other types of insurance. They may not also be as complete as you think they are&mdash;many packages don&apos;t include professional indemnity insurance, for example. Always read the fine print of your insurance policy to determine exactly what is and isn&apos;t covered.</p>
