...
const Page: NextPage = () => (
    <DefaultLayout>
        ...
        <SEO
            ...
            description="Following an infant’s sleep plan while travelling can be a challenge. A new sleep environment, a change in routine or different eating habits can all impact an infant’s sleep. Consider these seven tips for travelling with an infant, without disrupting the sleep schedule."
            canonical="/student-resources/blog/7-tips-for-travelling-with-a-baby"
        />
        ...
        <section>
            <div className="container col-12 mb-4 col-sm-10 col-md-8 col-lg-6 mb-lg-0">
                <div className="row mb-4">        
                    ...
                    <div className="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-10 offset-lg-1 text-center flex-column">
                        <p><img className="img-fluid" src={require('../../../images/sl-asian-young-pretty-mother-giving-bottle.jpg')} alt="mother giving baby bottle" /></p>
                    </div>                    
                    ...
                    <div className="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-10 offset-lg-1 text-center flex-column">                    
                     <p><img className="img-fluid" src={require('../../../images/sl-adorable-baby-drinking-milk-blue-bassinet.jpg')} alt="baby sleeping in a crib" /></p>
                     </div>
                </div>                
            </div>
        </section>
