...
import HowOnlineWorksBackgroundImage from '@/images/bg-white-green-light.jpg';
import CertificationSealImage from '@/images/certification-seal.png';
import HeroBackgroundImage from '@/images/home-hero-bg.jpg';
import HowItWorksImage from '@/images/how-it-works.svg';
import WhyChooseFeesIcon from '@/images/icon-why-choose-qc-no-hidden-fees.svg';
import WhyChooseOnlineIcon from '@/images/icon-why-choose-qc-online.svg';
import WhyChooseProvenIcon from '@/images/icon-why-choose-qc-proven.svg';
import WhyChooseTrainingIcon from '@/images/icon-why-choose-qc-training.svg';
import WhyChooseTutorIcon from '@/images/icon-why-choose-qc-tutor-guide.svg';
...
const Page: NextPage = () => (
  <>
    ...
    <section id="certifications" className="text-center">
      <div className="container">
        <div>
          <p><Image className="img-fluid" width="90" height="90" src={CertificationSealImage} alt="certification seal" /></p>
        ...
        <div className="row">
          <div className="col-12 mb-5 col-md-6 mb-md-0 col-lg-5 offset-lg-1 mb-5">
            ...
            <p className="text-uppercase"><Link href="/courses-and-tuition/sleep-consultant" className="text-info"><strong>view course</strong></Link></p>
          </div>
          <div className="col-12 col-md-6 col-lg-5 mb-5">
            ...
            <p className="text-uppercase"><Link href="/caregiver" className="text-info"><strong>view courses</strong></Link></p>
          </div>
          <div className="col-12 mb-5 col-md-6 mb-md-0 col-lg-5 offset-lg-1">
            ...
            <p className="text-uppercase"><Link href="/courses-and-tuition/skincare-consultant" className="text-info"><strong>view course</strong></Link></p>
          </div>
          <div className="col-12 col-md-6 col-lg-5">
            ...
            <p className="text-uppercase"><Link href="/courses-and-tuition/aging-in-place" className="text-info"><strong>view course</strong></Link></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="howOnlineWorks">
      <BackgroundImage src={HowOnlineWorksBackgroundImage} />
      <div className="container">
        <div className="row d-flex align-items-center">
          ...
          <div className="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-5 offset-lg-0 text-center flex-column">
            <Image className="img-fluid" width={427} height={427} src={HowItWorksImage as StaticImageData} alt="how it works" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        ...
        <div className="row d-flex align-items-center mb-5 mb-md-4">
          <div className="col-4 offset-4 col-md-2 offset-md-0 offset-lg-1 offset-xl-2 text-center mb-2 mb-md-0">
            <Image className="img-fluid" width="60" height="60" src={WhyChooseProvenIcon as StaticImageData} alt="icon proven" />
          </div>
        ...
        <div className="row d-flex align-items-center mb-5 mb-md-4">
          <div className="col-4 offset-4 col-md-2 offset-md-0 offset-lg-1 offset-xl-2 text-center mb-2 mb-md-0">
            <p><Image className="img-fluid" width="60" height="60" src={WhyChooseOnlineIcon as StaticImageData} alt="icon online" /></p>
          </div>
          <div className="col-12 col-md-10 col-lg-8 col-xl-6 text-center text-md-left">
        ...
        <div className="row d-flex align-items-center mb-5 mb-md-4">
          <div className="col-4 offset-4 col-md-2 offset-md-0 offset-lg-1 offset-xl-2 text-center mb-2 mb-md-0">
            <p><Image className="img-fluid" width="60" height="60" src={WhyChooseTutorIcon as StaticImageData} alt="tutor" /></p>
          </div>
          <div className="col-12 col-md-10 col-lg-8 col-xl-6 text-center text-md-left">
        ...
        <div className="row d-flex align-items-center mb-5 mb-md-4">
          <div className="col-4 offset-4 col-md-2 offset-md-0 offset-lg-1 offset-xl-2 text-center mb-2 mb-md-0">
            <p><Image className="img-fluid" width="60" height="60" src={WhyChooseTrainingIcon as StaticImageData} alt="training" /></p>
          </div>
          <div className="col-12 col-md-10 col-lg-8 col-xl-6 text-center text-md-left">
        ...
        <div className="row d-flex align-items-center">
          <div className="col-4 offset-4 col-md-2 offset-md-0 offset-lg-1 offset-xl-2 text-center mb-2 mb-md-0">
            <p><Image className="img-fluid" width="60" height="60" src={WhyChooseFeesIcon as StaticImageData} alt="no hidden fees" /></p>
          </div>
          <div className="col-12 col-md-10 col-lg-8 col-xl-6 text-center text-md-left">
    ...
    <EnrollmentSection>
      <strong>Ready to start your new career?</strong><br />Enroll today and launch your training!
    </EnrollmentSection>
  </>
);
