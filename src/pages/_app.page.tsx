  ...
  return (
    <ErrorBoundary fallback={<></>}>
      <Provider clientIp={pageProps.clientIp ?? null} userValues={pageProps.userValues}>
        ...
        {process.env.NEXT_PUBLIC_LIVECHAT_LICENSE && <LiveChat group={process.env.NEXT_PUBLIC_LIVECHAT_GROUP_ID} license={process.env.NEXT_PUBLIC_LIVECHAT_LICENSE} userValues={pageProps.userValues} />}
