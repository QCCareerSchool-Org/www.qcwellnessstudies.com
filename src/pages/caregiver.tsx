    ...
    <section id="heroSection">
      <div className="container">
        ...
        <div className="row d-flex align-items-center">
          <div className="col-12 mb-4 col-sm-10 col-md-8 offset-md-2 offset-lg-0 col-lg-6 mb-lg-0 text-center">
          ...
          <div className="col-12 col-sm-10 col-md-8 offset-md-2 offset-lg-0 col-lg-6 text-center">
