  ...
  <section id="accreditationSection">
    <div className="container text-center">
      <div className="col-12 col-lg-8 offset-lg-2 mb-6 mb-md-0">
        ...
        <p>QC is an online wellness school providing training that is flexible and affordable. A subsidiary of QC Career School, the online Wellness School holds an A+ standing in its accreditation by the Better Business Bureau— this is the highest consumer satisfaction rating.</p>
        <hr />
