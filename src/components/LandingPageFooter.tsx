  ...
  return (
    <footer id="landing-page-footer" className="footer bg-dark text-white mt-auto text-center">
      <div className="container">
        ...
        <p className="mt-3">To schedule a call with a student advisor, <Link href="/contact/#formSection"><a>click here</a></Link></p>
        <img src={require('../images/logo-footer.svg')} width="110" className="img-fluid my-4" alt="QC Wellness Studies" />
      </div>
    </footer>
  );
};
