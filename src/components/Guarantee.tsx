...
interface Props {
  ...
  twentyOneDays?: ReactElement;
  oneYear?: ReactElement;
  starting?: ReactElement;
}

export const Guarantee: FC<Props> = ({ courseName, doubleGuarantee, twentyOneDays, oneYear, starting }) => (
  <div className="container text-center">
    <h2 className="text-dark">Your Guarantee</h2>
    {starting ?? <p className="lead mb-5">Starting a new career can be scary but don&apos;t worry!<br />Once you enroll in QC&apos;s {courseName} Course, you&apos;ll be protected by a<br /><strong>{doubleGuarantee ? 'double' : '21-day'} money-back guarantee!</strong></p>}
    <div className="row">
      {doubleGuarantee
        ? (
          <>
            <div className="col-12 mb-5 col-md-6 mb-md-0 col-lg-5 offset-lg-1">
              <p><Image src={TwentyOneDayImage as StaticImageData} width="100" height="95" alt="21-day guarantee" /></p>
              <h3 className="text-dark">21-Day Guarantee</h3>
              {twentyOneDays ?? <p>Once your enrollment has been processed, you have 21 days to review the course materials and decide whether you want to take the course. If you decide this course isn&apos;t the right course for you, simply contact the school for a refund! As long as you haven&apos;t submitted any work to your tutor yet, your tuition will be refunded in full!</p>}
            </div>
