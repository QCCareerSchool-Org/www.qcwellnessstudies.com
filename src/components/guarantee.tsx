        ...
        ? (
          <>
            <div className="col-12 mb-5 col-md-6 mb-md-0 col-lg-5 offset-lg-1">
              <p><Image src={require('../images/21-day-guarentee.svg')} width="100" height="95" alt="21-day guarantee" /></p>
            ...
            <div className="col-12 col-md-6 col-lg-5">
              <p><Image src={require('../images/1-year-guarentee.svg')} width="100" height="95" alt="1-year guarantee" /></p>
