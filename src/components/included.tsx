  ...
  <div className="container">
    <div className="row">
      <div className="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
        ...
        <p>Once you graduate, you’ll be sent your certification by mail. The certification allows you to use the trademarked {certification} designation on your business cards, website, resume, and more. Get a certification that’s noticed and respected!</p>
      </div>
    </div>
  </div>
);
