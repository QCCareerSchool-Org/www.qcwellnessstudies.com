              ...
              <Navbar.Collapse id="main-navbar-nav" data-testid="main-nav">
                <Nav className="ml-auto mr-md-2 mr-lg-4">
                  <NavDropdown title="Courses &amp; Tuition" id="coursesDropdown">
                    ...
                    <NavDropdown.Divider />
                    <Link href="/courses-and-tuition/professional-caregiving"><a className="dropdown-item"><strong>Caregiver</strong>&nbsp;&nbsp;<span className="badge badge-secondary">New</span></a></Link>
                  ...
                  <NavDropdown title="About" id="aboutDropdown">
                    ...
                    <Link href="/student-features/sarah-pashniak"><a className="dropdown-item">Student Feature</a></Link>
