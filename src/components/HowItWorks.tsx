...
export const HowItWorks: FC<Props> = props => (
  <div className="container text-center">
    <div className="col-12 col-md-10 offset-md-1 col-lg-10 offset-lg-1 mb-4">
      ...
      {props.enroll ?? <p>With no enrollment or study deadlines, you can join the {props.courseName} whenever you&apos;re ready and start right away. Within a day of enrolling, you&apos;ll get access to your online student center and course materials.</p>}
      <hr className="my-4" />
      <IoMdHome size={40} />
      <h3 className="text-dark">Study From Home</h3>
      {props.study ?? <p>Log into your Student Center to complete interactive lessons, watch detailed instructional videos and submit your coursework. All course materials are available online, allowing you to study from home or on the go.</p>}
      ...
      {props.graduate ?? <p>Upon completing all course units and paying your tuition in full, you&apos;ll graduate from QC Wellness Studies and receive your {props.certification} certification. With this certification and the business training provided in the course, you&apos;ll be fully equipped to launch your successful business!</p>}
      <hr className="my-4" />
