...
import FourteenDayIcon from '@/images/14-day-guarentee.svg';
  ...
  <section id="guaranteeSection">
    ...
    <div className="container text-center">
      <div className="col-12 col-lg-8 offset-lg-2 mb-6 mb-md-0">
        <p><Image src={FourteenDayIcon as StaticImageData} alt="14-day-guarentee" /></p>
        <h2 className="text-dark">QC&apos;s Guarantee</h2>
        <p>At QC, providing high quality online wellness courses is our top priority. With QC&apos;s 100% money-back guarantee, you&apos;ll have 14 days to review your course materials from the day you receive them. If you have a question or concern, contact us. If, in the 14 days, you decide the course isn&apos;t for you, we&apos;ll give you a full refund.</p>
      </div>
    </div>
  </section>
);
