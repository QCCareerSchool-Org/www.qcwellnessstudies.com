...
export const HowItWorksCaregiver: React.FC = () => (
  <div className="container text-center">
    <div className="col-12 col-md-10 offset-md-1 col-lg-10 offset-lg-1 mb-4">
      ...
      <p>With no enrollment or study deadlines, you can enroll in the professional caregiver course whenever you're ready and start working on your course right away. Within a day of enrolling, you'll receive access to your online student center, course materials, and assignment templates.</p>
      <hr className="my-4" />
      <IoMdHome size={40} />
